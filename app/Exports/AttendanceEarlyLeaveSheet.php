...
class AttendanceEarlyLeaveSheet implements FromCollection, WithHeadings, WithTitle, WithStyles
{
    public function __construct(protected $records) {}

    public function title(): string { return '早退'; }
    ...
    {
        return $this->records->filter(fn($r) => $r->early_leave_minutes > 0)->map(function ($r) {
            return [
